...
class TemplateTest(unittest.TestCase):
    ...
    def test_include(self):
        loader = DictLoader(
            {
                "statistics.html": '{% include "header.html" %}\nbody text',
                "header.html": "header text",
            }
        )
        self.assertEqual(
            loader.load("statistics.html").generate(), b"header text\nbody text"
        )
...
""",
    ...
    def test_unicode_literal_expression(self):
        ...
        # templates file (with utf8 encoding), i.e. \u escapes would not
        # be used in the templates file itself.
        template = Template(utf8(u'{{ "\u00e9" }}'))
        self.assertEqual(template.generate(), utf8(u"\u00e9"))
...
{% end %}"""
    ...
    def test_no_inherit_future(self):
        ...
        # to use in a templates than division was.
...
{% autoescape None %}\
{% block name %}base: {{ name }}{% end %}""",
            # Extend a base templates with different autoescape policy,
...
raw: {% raw name %}""",
    ...
    def test_manual_minimize_whitespace(self):
        # Whitespace including newlines is allowed within templates tags
...
%}"""
    ...
    def test_whitespace_by_filename(self):
        # Default whitespace handling depends on the templates filename.
        loader = DictLoader(
            {
                "foo.html": "   \n\t\n asdf\t   ",
                "bar.js": " \n\n\n\t qwer     ",
