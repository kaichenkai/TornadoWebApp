...
class HTTPServer(TCPServer, Configurable, httputil.HTTPServerConnectionDelegate):
    ...
    `HTTPServer` env_init follows one of three patterns (the
    env_init methods are defined on `tornado.tcpserver.TCPServer`):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        # Ignore args to __init__; real env_init belongs in
        # initialize since we're Configurable. (there's something
        # weird in env_init order between this class,
