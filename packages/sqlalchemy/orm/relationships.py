...
class RelationshipProperty(StrategizedProperty):
    ...
    def __init__(
        ...
        env_init" time, which happens only when mappers are first used,
        ...
        :param argument:
          ...
          function which is evaluated at mapper env_init time, and may
        ...
        :param secondary:
          ...
          mapper env_init time.  When using Declarative, it may also
        ...
        :param foreign_keys:
          ...
          callable function which is evaluated at mapper env_init time,
    ...
    def _process_dependent_arguments(self):
        ...
        # deferred env_init.  This technique is used
